...
WebUI.waitForElementClickable(findTestObject('Supply Home Page/Button Supplier sidebar'), 20)

WebUI.click(findTestObject('Supply Home Page/Button Supplier sidebar'))
