...
WebUI.click(findTestObject('Supply-Settings-Item-Item Name/Button Clear Field di Edit Item Name'))
...
WebUI.verifyTextPresent('You must pick a measurement', false)
