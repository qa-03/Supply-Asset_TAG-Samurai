...
WebUI.setText(findTestObject('Supply-Settings-Group/Tambah New Group - Field Group Name'), '_AAACCC')

WebUI.setText(findTestObject('Supply-Settings-Group/Tambah New Group - Field Alias Code'), '_AC')
